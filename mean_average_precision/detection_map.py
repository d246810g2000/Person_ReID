...
class DetectionMAP:
    ...
    def compute_mAP(self, interpolated=True, class_names=None):
    ...
    def plot(self, interpolated=True, class_names=None, figsize=30):
        """
        ...
        fig, axes = plt.subplots(nrows=grid, ncols=grid, figsize=(figsize, figsize))
        mean_average_precision = []
        ...
        plt.suptitle("Mean average precision : {:0.2f}".format(sum(mean_average_precision)/len(mean_average_precision)), y=1.01, fontsize=24)
        fig.tight_layout()
